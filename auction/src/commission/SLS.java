...
public class SLS {
    private final int MAX_ITERATIONS = 15000;
    ...
    private A changingActionOrder(A a, Vehicle v, int front, int rear) {
        A generated = new A(a);
    ...
    private boolean canSwap(A a, Vehicle v, Action act1, Action act2, int indAct1, int indAct2) {
